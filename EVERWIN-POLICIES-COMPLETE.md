...
2. [Termos e Condições](#2-termos-e-condições)
3. [Política de Cookies](#3-política-de-cookies)
4. [Política de Pagamento](#4-política-de-pagamento)
5. [Política de Saque](#5-política-de-saque)
6. [Taxas Gerais](#6-taxas-gerais)
7. [Divulgação de Risco](#7-divulgação-de-risco)
8. [Política de Execução de Ordens](#8-política-de-execução-de-ordens)
9. [Negociação de Margem](#9-negociação-de-margem)
10. [Política AML & KYC](#10-política-aml--kyc)
11. [Contas Demo](#11-contas-demo)
12. [Política de Avaliação Prop](#12-política-de-avaliação-prop)
13. [Planos Prop e Taxas](#13-planos-prop-e-taxas)
14. [Política de Acesso e Credenciais Prop](#14-política-de-acesso-e-credenciais-prop)
15. [Política de Payout e Retirada - Programa Prop](#15-política-de-payout-e-retirada---programa-prop)
16. [Política de Acesso, Credenciais e Integridade de Conta Prop](#16-política-de-acesso-credenciais-e-integridade-de-conta-prop)
17. [Política de Restrições Operacionais e Proibições de Trading Prop](#17-política-de-restrições-operacionais-e-proibições-de-trading-prop)
18. [Compras, Reset e Cancelamento Prop](#18-compras-reset-e-cancelamento-prop)

---

## 1. Política de Privacidade

**Como a Everwin coleta, utiliza, compartilha, armazena e protege dados pessoais no site, na corretora e nas jornadas do programa Prop.**
...
### 1.2 Dados que podemos coletar

- **Identificação:** nome, e-mail, telefone, país, idioma, dados cadastrais e dados informados em formulários.
- **Operacionais:** produto contratado, plano selecionado, status da submissão, histórico de suporte, dados de login e uso do portal.
- **Financeiros e transacionais:** método de pagamento, status de cobrança, moeda, valor, identificadores do pedido e eventos antifraude.
- **Técnicos:** IP, tipo de dispositivo, navegador, sistema operacional, logs, identificadores de sessão, idioma e localização aproximada por país.
- **Compliance:** documentos, provas de identidade, residência, titularidade e outras informações necessárias para KYC, AML, prevenção a fraude ou payout.

### 1.3 Fontes de coleta
...
### 1.5 Bases legais e legitimidade
...
### 1.7 Retenção, segurança e direitos do titular
...
**Termos gerais que regem o acesso ao site, às páginas comerciais, aos portais de cliente e às experiências digitais operadas pela Everwin.**
...
### 2.1 Elegibilidade e uso permitido
...
### 2.2 Cadastro, credenciais e integridade da conta
...
### 2.3 Natureza informacional e ausência de aconselhamento
...
### 2.4 Produtos específicos e políticas complementares
...
### 2.5 Propriedade intelectual e uso de conteúdo
...
### 2.6 Disponibilidade, alterações e responsabilidade
...
**Como utilizamos cookies, pixels, local storage e tecnologias similares para operação, personalização, segurança e medição.**
...
### 3.1 Categorias de tecnologia utilizadas

- **Essenciais:** necessárias para login, navegação, idioma, segurança, persistência de sessão e funcionamento do site.
- **Preferência:** lembram idioma, escolhas do usuário, estado de formulários e configurações relevantes.
- **Medição e analytics:** ajudam a entender páginas acessadas, performance de campanhas, eventos, funis e estabilidade técnica.
- **Segurança:** apoiam verificação de tráfego, mitigação de abuso, antifraude, limitação de tentativas e análise de risco.
...
**Regras gerais para cobranças, compras de planos, aprovação de pedidos, verificação e prevenção a fraude nos produtos da Everwin.**
...
### 4.1 Canais e meios autorizados
...
### 4.3 Pagamentos do programa Prop
...
### 4.4 Taxas, impostos e conversão
...
### 4.5 Disputas, chargebacks e abuso
...
**Condições gerais para solicitações de saque, devolução de valores, titularidade e verificações complementares.**
...
### 5.2 Verificação e titularidade
...
### 5.4 Retenções, recusas e ajustes
...
**Visão consolidada das categorias de taxas, tarifas de terceiros e custos operacionais que podem existir nos produtos Everwin.**
...
### 6.3 Custos administrativos e de exceção
...
## 7. Divulgação de Risco

**Avisos importantes sobre riscos de mercado, tecnologia, execução, alavancagem e programas de avaliação.**
...
### 7.1 Risco de perda e volatilidade
...
### 7.2 Risco tecnológico e operacional
...
### 7.3 Risco em ambientes simulados e de avaliação
...
### 7.4 Risco de alavancagem e margem
...
### 7.5 Ausência de promessa ou aconselhamento
...
## 8. Política de Execução de Ordens

**Princípios gerais sobre formação de preço, latência, rejeição, logs operacionais e diferenças entre execução indicativa e efetiva.**
...
### 8.2 Preço indicativo e slippage
...
### 8.3 Ambientes simulados e Prop
...
### 8.4 Rejeição, cancelamento e correção
...
### 8.5 Logs, auditoria e investigação
...
**Informações essenciais sobre produtos com margem, alavancagem, risco de liquidação e adequação do usuário.**
...
### 9.2 Risco de liquidação e chamadas de margem
...
**Diretrizes para identificação de clientes, verificação documental, prevenção à lavagem de dinheiro, sanções e fraude.**
...
### 10.1 Verificação de identidade
...
### 10.2 Origem de fundos e análise de risco
...
### 10.5 Cooperação e retenção de registros
...
> A adoção de controles AML/KYC não implica aceitação automática de qualquer usuário, pagamento ou pedido de payout.

---

## 11. Contas Demo

**Informações sobre ambientes de demonstração, testes, simulação e suas limitações em relação a operações reais.**
...
### 11.1 Diferença para ambiente real
...
### 11.2 Resets, limites e disponibilidade
...
## 12. Política de Avaliação Prop

**Regras operacionais da jornada de avaliação, critérios de aprovação, limites de risco, revisão interna e desclassificação no programa Prop da Everwin.**
...
### 12.2 Requisitos operacionais vigentes

| Parâmetro operacional | Padrão atual | Observação |
|----------------------|--------------|------------|
...
> Os parâmetros acima refletem o padrão operacional atualmente exibido e podem ser ajustados prospectivamente pela política comercial e de risco vigente.

### 12.3 Elegibilidade e documentação
...
### 12.4 Conduta, consistência e integridade
...
## 13. Planos Prop e Taxas

**Tabela consolidada dos planos exibidos atualmente, moedas praticadas, parâmetros operacionais padrão e observações comerciais do programa Prop.**
...
### 13.1 Regras padrão atualmente vinculadas à avaliação
...
### 13.2 Conversão, tributos e taxas externas
...
### 13.3 Promoções e atualização comercial
...
## 14. Política de Acesso e Credenciais Prop

**Como são criados, vinculados, protegidos e recuperados os acessos ao portal Everwin e às contas relacionadas ao programa Prop.**
...
### 14.2 Provisionamento de acesso
...
### 14.3 Responsabilidade do usuário
...
### 14.4 Recuperação, redefinição e bloqueio
...
### 14.5 Vínculo entre usuário e contas Prop
...
## 15. Política de Payout e Retirada - Programa Prop

**Requisitos de elegibilidade, revisão operacional, validação de titularidade e condições de retenção/negação aplicáveis a solicitações de payout no programa Prop.**
...
### 15.1 ELEGIBILIDADE OPERACIONAL E COMPLIANCE
...
### 15.2 VALIDAÇÃO DE SEGURANÇA E ACESSO ACCOUNT
...
- VPN, Proxy ou técnicas de mascaramento de IP são expressamente proibidos. Sua detecção constituirá violação grave de integridade.
...
### 15.3 DETECÇÃO AUTOMATIZADA E PROIBIÇÃO DE BOTS
...
### 15.4 REVISÃO OPERACIONAL APROFUNDADA
...
### 15.5 VALIDAÇÃO DE TITULARIDADE E DOCUMENTAÇÃO
...
### 15.6 CAUSAS DE RETENÇÃO E NEGAÇÃO PERMANENTE DE PAYOUT
...
- Múltiplas contas sob mesmo usuário, documento ou endereço IP será investigada por fraude de programa.
- Any pattern of abuse, manipulação de sistema, ou tentativa de explorar falhas da plataforma.

### 15.7 MÉTODOS DE PAGAMENTO, MOEDAS E LIMITES
...
### 15.9 PRAZOS DE PROCESSAMENTO E COMUNICAÇÃO
...
### 15.11 INTEGRAÇÃO COM OUTRAS POLÍTICAS
...
## 16. Política de Acesso, Credenciais e Integridade de Conta Prop

**Requisitos obrigatórios para acesso seguro de conta, uso de credenciais, verificação de identidade e manutenção da integridade operacional.**
...
### 16.1 AUTENTICAÇÃO E CREDENCIAIS
...
### 16.2 PROIBIÇÃO EXPRESSA DE MÚLTIPLOS ACESSOS
...
### 16.3 DETECÇÃO BIOMÉTRICA E COMPORTAMENTAL
...
### 16.4 PROIBIÇÃO DE COMPARTILHAMENTO E CONTROLE REMOTO
...
### 16.5 VERIFICAÇÃO DE IDENTIDADE CONTÍNUA (KYC)
...
### 16.6 RESPONSABILIDADE POR ACESSO NÃO AUTORIZADO
...
## 17. Política de Restrições Operacionais e Proibições de Trading Prop

**Instrumentos, estratégias, comportamentos e técnicas proibidas no programa Prop para proteger integridade operacional e conformidade regulatória.**
...
### 17.1 PROIBIÇÃO DE BOTS, APIS E AUTOMAÇÃO
...
### 17.2 ATIVIDADES PROIBIDAS DE ALTA FREQUÊNCIA
...
### 17.3 INSTRUMENTOS ESPECÍFICOS PROIBIDOS
...
### 17.4 RESTRIÇÕES DE ALAVANCAGEM E EXPOSIÇÃO
...
## 18. Compras, Reset e Cancelamento Prop

**Regras comerciais para aquisição de avaliações, pedidos duplicados, resets, reativações, cancelamento e recontratação no programa Prop.**
...
### 18.1 Compras e pedidos duplicados
...
### 18.2 Provisionamento após compra
...
### 18.4 Reset, recompra e nova tentativa
...
### 18.5 Cooldown e limites administrativos
...
### 18.6 Política comercial vigente
